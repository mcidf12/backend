                ...
                <table width="640"
                    ...
                    <tr>
                        <td class="inner" style="padding:32px;">
                            ...
                            <p style="margin:0 0 14px 0; color:#5b6b7a; font-size:13px;">
                                Si no solicitaste este restablecimiento, no es necesario realizar ninguna acción. Si
                                detectas actividad sospechosa, contáctanos inmediatamente.
                            </p>
